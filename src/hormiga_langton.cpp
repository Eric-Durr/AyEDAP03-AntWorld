...
int main(int argc, char *argv[])
{
    ...
    if (argc == 4)
    {
        ...
        ExpExpLangtonEnvironment default_env(rows_given, columns_given);
    ...
    if (argc == 6)
    {
        ...
        ExpExpLangtonEnvironment anted_env(rows_given, columns_given, ant_i_pos, ant_j_pos);
        std::cout << "Environment preview:\n\n"
                  << "Steps to take: " << steps_given << "\n"
                  << "Columns of the grid: " << columns_given << "\n"
                  << "Rows of the grid: " << rows_given << "\n"
    ...
    if (argc == 7)
    {
        ...
        ExpExpLangtonEnvironment anted_env(rows_given, columns_given, ant_i_pos, ant_j_pos, direction_given);
        std::cout << "Environment preview:\n\n"
                  << "Steps to take: " << steps_given << "\n"
                  << "Columns of the grid: " << columns_given << "\n"
                  << "Rows of the grid: " << rows_given << "\n"
